 ...
 */
export const SUPPORTED_LANGUAGES = ["gb"] as const;
export type LanguageId = (typeof SUPPORTED_LANGUAGES)[number];

/**
 * Defines supported locales in the App.
 */
export const SUPPORTED_LOCALES = ["en-GB"] as const satisfies AllLocale[];
export type SupportedLocale = (typeof SUPPORTED_LOCALES)[number];
export const DEFAULT_LOCALE = "en-GB" as const satisfies AllLocale;

/**
 * Defines available markets in the App.
 */
export const SUPPORTED_MARKETS = ["gb"] as const;
export type MarketId = (typeof SUPPORTED_MARKETS)[number];

/**
 * Defines supported currencies in the App.
 */
export const SUPPORTED_CURRENCIES = ["EUR"] as const satisfies AllCurrency[];
